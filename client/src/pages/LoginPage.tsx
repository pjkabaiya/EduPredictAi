      ...
      >
        ...
        <form onSubmit={handleSubmit} className="bg-navy-800/50 backdrop-blur-sm border border-white/5 rounded-2xl p-8 space-y-5">
          ...
          <div className="flex items-center justify-end">
            <Link to="/forgot-password" className="text-sm text-emerald-400 hover:text-emerald-300 transition-colors">Forgot password?</Link>
          </div>
          ...
          <p className="text-center text-sm text-navy-400">
            ...
            <Link to="/register" className="text-emerald-400 hover:text-emerald-300 transition-colors font-medium">Create one</Link>
          </p>
        </form>
      </motion.div>
    </div>
